    ...
    <section className="text-center mb-12 fade-in" id="hero-section">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
          ...
          <span className="text-orange-500">All-Star!</span>
        </h2>
        ...
        <Button
          onClick={onStart}
          size="lg"
          className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl"
        >
